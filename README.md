...
I build software at the intersection of engineering and physics: full-stack platforms, geospatial research pipelines, and terminal first aesthetics.
...
| :--- | :--- | :--- |
| [AveResearch2026](https://github.com/Implycitt/AveResearch2026) | Bird-urbanization research: 600k+ record ingestion, WorldPop raster density modeling, hypothesis testing | Python, NumPy, SciPy |
| [PrintIt](https://github.com/Implycitt/PrintIt) | JavaFX label manager that cut label printing time ~50% for an active retail business | Java, JavaFX, SQLite |
| [gdsclsu](https://github.com/Implycitt/gdsclsu) | Full-stack platform for LSU GDSC — event check-ins and member tracking for 100+ members | Web, Fullstack |
| [Guardium](https://github.com/Implycitt/Guardium) | 2D tower-defense game in Rust with Bevy | Rust, Bevy |
...
![JavaFX](https://img.shields.io/badge/JavaFX-23A8D9?style=for-the-badge)
